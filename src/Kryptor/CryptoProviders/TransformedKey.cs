...
namespace SAPTeam.Kryptor.CryptoProviders
{
    ...
    public sealed class TransformedKey : CryptoProvider
    {
        ...
        {
            return await AesHelper.EncryptAesEcbAsync(chunk, Transformers.CreateKey(KeyStore, process), cancellationToken);
        }
        ...
        {
            return await AesHelper.DecryptAesEcbAsync(cipher, Transformers.CreateKey(KeyStore, process), cancellationToken);
        }
    }
}
